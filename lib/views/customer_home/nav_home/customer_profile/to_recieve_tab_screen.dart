...
class Cancelled extends StatefulWidget {
  ...
  @override
  State<Cancelled> createState() => _ToRecieveTabScreenState();
}

class _ToRecieveTabScreenState extends State<Cancelled> {
  @override
            ...
            children: [
              ...
              Consumer(
                builder: (context, ref, _) {
                  ...
                  final coaches = ref.watch(orderCancelledCustomer);
                  ref.refresh(orderCancelledCustomer);
                  return coaches.when(
                    data: (userModelList) {
